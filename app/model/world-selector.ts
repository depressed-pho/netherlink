...
export class WorldSelectorModel {
    ...
    private readonly worldsBus: Bacon.Bus<Map<WorldID, World>>;
    public readonly worlds: Bacon.Property<Map<WorldID, World>>;

    public constructor(storage: NLStorage) {
        this.storage = storage;

        this.worldsBus = new Bacon.Bus<Map<WorldID, World>>();
        this.worlds    = this.worldsBus.toProperty(new Map<WorldID, World>(storage));
    }
}
